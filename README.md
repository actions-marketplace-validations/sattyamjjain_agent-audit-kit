...
<p align="center">
  ...
  <a href="#what-it-scans"><img src="https://img.shields.io/badge/rules-269-blue.svg" alt="Rules: 269"></a>
...
- **<!-- rule-count:total -->269<!-- /rule-count --> rules** across 12 security categories, covering the 2026 CVE wave
...
**<!-- rule-count:total -->269<!-- /rule-count --> rules total.** Every finding includes severity, evidence, remediation, OWASP references, Adversa references, and CVE links where applicable.
...
| **ASI03** | Memory Poisoning | 64 |
| **ASI04** | Identity & Privilege Abuse | 52 |
...
| Detection rules (static) | **<!-- rule-count:total -->269<!-- /rule-count -->** | Runtime policies, not rules | ~30 | LLM-assisted |
