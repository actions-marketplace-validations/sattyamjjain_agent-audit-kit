...
<p align="center">
  ...
  <a href="#what-it-scans"><img src="https://img.shields.io/badge/rules-271-blue.svg" alt="Rules: 271"></a>
...
**<!-- rule-count:total -->271<!-- /rule-count --> rules total.** Every finding includes severity, evidence, remediation, OWASP references, Adversa references, and CVE links where applicable.
...
| **ASI04** | Identity & Privilege Abuse | 53 |
...
| Detection rules (static) | **<!-- rule-count:total -->271<!-- /rule-count -->** | Runtime policies, not rules | ~30 | LLM-assisted |
