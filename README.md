...
<p align="center">
  ...
  <a href="#what-it-scans"><img src="https://img.shields.io/badge/rules-272-blue.svg" alt="Rules: 272"></a>
...
- **<!-- rule-count:total -->272<!-- /rule-count --> rules** across 12 security categories, covering the 2026 CVE wave
...
jobs:
  scan:
    ...
    steps:
      ...
      - uses: sattyamjjain/agent-audit-kit@v0.3.63
        id: scan
        with:
          fail-on: high
...
**<!-- rule-count:total -->272<!-- /rule-count --> rules total.** Every finding includes severity, evidence, remediation, OWASP references, Adversa references, and CVE links where applicable.
...
| **ASI04** | Identity & Privilege Abuse | 54 |
| **ASI05** | Cascading Failures | 35 |
...
| Detection rules (static) | **<!-- rule-count:total -->272<!-- /rule-count -->** | Runtime policies, not rules | ~30 | LLM-assisted |
