...
- **<!-- rule-count:total -->289<!-- /rule-count --> rules** across 12 security categories, covering the 2026 CVE wave
...
**<!-- rule-count:total -->289<!-- /rule-count --> rules total.** Every finding includes severity, evidence, remediation, OWASP references, Adversa references, and CVE links where applicable.
...
| **ASI06** | Unauthorized Capability Acquisition | 37 |
...
| Detection rules (static) | **<!-- rule-count:total -->289<!-- /rule-count -->** | Runtime policies, not rules | ~30 | LLM-assisted |
