...
<p align="center">
  ...
  <a href="#what-it-scans"><img src="https://img.shields.io/badge/rules-265-blue.svg" alt="Rules: 265"></a>
...
- **<!-- rule-count:total -->265<!-- /rule-count --> rules** across 12 security categories, covering the 2026 CVE wave
...
jobs:
  scan:
    ...
    steps:
      ...
      - uses: sattyamjjain/agent-audit-kit@v0.3.57
        id: scan
        with:
          fail-on: high
...
**<!-- rule-count:total -->265<!-- /rule-count --> rules total.** Every finding includes severity, evidence, remediation, OWASP references, Adversa references, and CVE links where applicable.
...
| Detection rules (static) | **<!-- rule-count:total -->265<!-- /rule-count -->** | Runtime policies, not rules | ~30 | LLM-assisted |
