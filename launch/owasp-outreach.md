...
316 rules across 93 scanners cover:
...
I built AgentAuditKit, an open-source (MIT) security scanner for MCP-connected AI agent pipelines. It maps 316 detection rules to all 10 risks in the OWASP MCP Top 10:
...
Hey everyone — I built an open-source security scanner for MCP agent configs. 316 detection rules that catch hardcoded secrets, shell injection, tool poisoning (invisible Unicode in tool descriptions), and rug pull attacks.
