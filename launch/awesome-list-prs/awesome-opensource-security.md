...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines with 282 rules, OWASP MCP/Agentic Top 10 mapping, and SARIF output
```
...
- 282 rules across 87 scanner modules
